...
import { SignUpFormProps } from "../utils/interfaces";
...
export default function SignUpForm({ onSubmit }: { onSubmit: (event: BaseSyntheticEvent) => void }) {
    ...
    return (
        <>
            <form onSubmit={onSubmit} className="flex flex-col space-y-6 w-full text-[rgba(var(--primary-rgb))] opacity-100 drop-shadow-2xl">
                <div className="grid md:grid-cols-2 gap-y-6 md:gap-6">
                    <div className="relative z-0 w-full group">
                        <input type="text" name="first_name" id="first_name" className="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-[rgb(var(--primary-rgb))] peer" placeholder=" " required />
                    ...
                    <div className="relative z-0 w-full group">
                        <input type="text" name="last_name" id="last_name" className="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-[rgb(var(--primary-rgb))] peer" placeholder=" " required />
                ...
                <div className="relative z-0 w-full group">
                    <input type="email" name="email" id="email" className="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-[rgb(var(--primary-rgb))] peer" placeholder=" " required />
                ...
                <div className="relative z-0 w-full mb-5 group">
                    <input type="password" name="password" id="password" className="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-[rgb(var(--primary-rgb))] peer" placeholder=" " required onKeyUp={(e) => setPass(e.target.value)} />
                ...
                <div>
                    <input type="submit" value="Sign Up" className="mt-4 p-3 border rounded-md w-full self-end cursor-pointer hover:bg-slate-50 transition-colors ease-in delay-75" />
                </div>
