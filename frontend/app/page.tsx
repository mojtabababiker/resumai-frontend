...
export default function Home() {
  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-between p-0 mt-28 md:mt-20 mx-auto md:p-16z xl:m-24">
      {<NavBar></NavBar>}
      {/* Hero */}
      <section className="h-[100svh - 60px] md:h-[100svh - 120px] flex flex-col md:flex-row gap-4 py-4 px-5">
        {/* slogan */}
        <div className="relative w-full md:w-1/2 flex flex-col justify-around items-center gap-4">
          ...
          <ButtonSolid className="lg:self-start opacity-75 px-5 py-4 text-lg">Build Your Resume</ButtonSolid>
        </div>
        {/* hero image */}
